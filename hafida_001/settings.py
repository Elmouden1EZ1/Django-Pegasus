"""
Django settings for hafida project.
...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-B2mwkHYBkBFh1HSfsxacOkWJ7BvO6opLMBb0hi1M")
...
WSGI_APPLICATION = "hafida_001.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="hafida_001"),
            "USER": env("DJANGO_DATABASE_USER", default="postgres"),
            "PASSWORD": env("DJANGO_DATABASE_PASSWORD", default="admin"),
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="elodie.chassin2000@gmail.com")
...
SPECTACULAR_SETTINGS = {
    "TITLE": "hafida",
    "DESCRIPTION": "Hafida_App",  # noqa: E501
    "VERSION": "0.1.0",
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("hafida"),
    "URL": "http://localhost:8000",
    "DESCRIPTION": gettext_lazy("Hafida_App"),  # noqa: E501
    "IMAGE": "https://upload.wikimedia.org/wikipedia/commons/2/20/PEO-pegasus_black.svg",
    "KEYWORDS": "SaaS, django",
    "CONTACT_EMAIL": "elodie.chassin2000@gmail.com",
}

# set this to True in production to have URLs generated with https instead of http
USE_HTTPS_IN_ABSOLUTE_URLS = env.bool("USE_HTTPS_IN_ABSOLUTE_URLS", default=False)

ADMINS = [("Hafida", "elodie.chassin2000@gmail.com")]
...
LOGGING = {
    ...
    "loggers": {
        ...
        "hafida_001": {
            "handlers": ["console"],
            "level": env("HAFIDA_001_LOG_LEVEL", default="INFO"),
        },
    },
}
